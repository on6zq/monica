...
return [
    ...
    'sidebar_settings_relationscheck' => 'Relations check',
    'sidebar_settings_auditlogs' => 'Audit logs',

    'relationscheck_reciprocals_title' => 'Missing reciprocal relationships',
    'relationscheck_reciprocals_help' => 'These relationships exist in one direction but are missing the expected counterpart (e.g. A is spouse of B but B has no spouse relationship back to A).',
    'relationscheck_reciprocals_none' => 'All relationships have their reciprocal. Nothing to fix.',
    'relationscheck_fix_reciprocals' => 'Fix all missing reciprocals',
    'relationscheck_fixed_reciprocals' => '{0} No reciprocals were missing.|{1} :count reciprocal created.|[2,*] :count reciprocals created.',

    'relationscheck_suggestions_title' => 'Suggested relationships',
    'relationscheck_suggestions_help' => 'These relationships are inferred from existing ones but have not been recorded yet (e.g. two contacts who share a parent are likely siblings).',
    'relationscheck_suggestions_none' => 'No relationship suggestions found.',
    'relationscheck_apply_suggestions' => 'Add all suggested relationships',
    'relationscheck_applied_suggestions' => '{0} No suggestions were applied.|{1} :count relationship created.|[2,*] :count relationships created.',
    'relationscheck_create_suggestion' => 'Create',
    'relationscheck_created_suggestion' => 'Relationship created.',

    'relationscheck_circular_title' => 'Circular parent-child relationships',
    'relationscheck_circular_help' => 'These pairs are marked as parent of each other, which is impossible. This usually means the relationship was entered in the wrong direction in Monica. You will need to fix these manually before the suggestions below will be reliable.',
    'relationscheck_circular_none' => 'No circular relationships detected.',
    'relationscheck_col_contact_a' => 'Contact A',
    'relationscheck_col_contact_b' => 'Contact B',

    'relationscheck_col_from' => 'From',
    'relationscheck_col_type' => 'Type',
    'relationscheck_col_to' => 'To',
    'relationscheck_col_missing' => 'Missing reciprocal',
    'relationscheck_col_suggested_type' => 'Suggested type',
    'relationscheck_col_reason' => 'Reason',
